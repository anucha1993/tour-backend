...
export default function CreateCityPage() {
  ...
  useEffect(() => {
    const fetchCountries = async () => {
      try {
        const response = await citiesApi.getCountries();
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">เพิ่มเมืองใหม่</h1>
          <p className="text-gray-600">กรอกข้อมูลเมืองที่ต้องการเพิ่ม</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              <Input
                ...
                error={errors.slug?.[0]}
              />
              <p className="mt-1 text-xs text-gray-500">ถ้าไม่กรอก จะสร้างจากชื่ออังกฤษอัตโนมัติ</p>
            </div>
