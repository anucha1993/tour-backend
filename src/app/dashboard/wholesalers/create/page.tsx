...
export default function CreateWholesalerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await wholesalersApi.create(formData);
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Add Wholesaler</h1>
          <p className="text-gray-500 mt-1">ลงทะเบียน Wholesale Partner ใหม่</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-end gap-4 pt-4">
          <Link href="/dashboard/wholesalers">
