...
export default function LoginPageEditor() {
  ...
  const fetchContent = async () => {
    try {
      setLoading(true);
      const response = await apiClient.get<PageContent>('/page-content/login_page');
  ...
  const handleDeleteImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/page-content/login_page/image`, {
        method: 'DELETE',
        headers: {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 relative">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">จัดการหน้าเข้าสู่ระบบ (Login Page)</h1>
          <p className="text-gray-500 mt-1">จัดการรูปภาพและ SEO สำหรับหน้า Login</p>
        </div>
        {updatedAt && (
                ...
                <div className="w-full md:w-1/2 space-y-4">
                   <div>
                       ...
                       <input 
                          ...
                          placeholder="เช่น Travel Image, Login Background"
                       />
