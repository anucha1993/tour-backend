...
export default function TermsPage() {
  ...
  const fetchContent = async () => {
    try {
      setLoading(true);
      const response = await apiClient.get<PageContent>('/page-content/terms');
  ...
  const getDefaultContent = () => {
    return `<h2>1. ข้อตกลงทั่วไป</h2>
<p>การใช้บริการของเว็บไซต์นี้ ถือว่าท่านได้ยอมรับและตกลงที่จะปฏิบัติตามข้อกำหนดและเงื่อนไขการให้บริการทั้งหมด</p>
...
<h2>3. การยกเลิกและการเปลี่ยนแปลง</h2>
<ul>
<li>กรณียกเลิกก่อนเดินทาง 30 วัน คืนเงินเต็มจำนวน</li>
...
<p>บริษัทจะไม่รับผิดชอบต่อความล่าช้าหรือการเปลี่ยนแปลงที่เกิดจากสายการบิน, สภาพอากาศ หรือเหตุสุดวิสัย</p>

<h2>5. การติดต่อ</h2>
<p>หากท่านมีข้อสงสัยหรือต้องการสอบถามข้อมูลเพิ่มเติม สามารถติดต่อเราได้ทางช่องทางที่ระบุไว้ในเว็บไซต์</p>`;
  };
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await apiClient.put<PageContent>('/page-content/terms', { content });
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
            ...
            <span>/</span>
            <span className="text-gray-700">เงื่อนไขการให้บริการ</span>
          </div>
          ...
          <p className="text-gray-600 mt-1">
            จัดการเนื้อหาหน้าเงื่อนไขการให้บริการ (Terms of Service)
          </p>
        </div>
