...
// Production:  https://api.nexttripholiday.com/api
export const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://api.nexttripholiday.com/api';
...
export interface InternationalTourSetting {
  ...
  sidebar_blog_posts_limit?: number;
  sidebar_popular_tours_limit?: number;
  sidebar_blog_posts_title?: string | null;
  sidebar_popular_tours_title?: string | null;
  sidebar_contact_title?: string | null;
  sidebar_contact_phone?: string | null;
  sidebar_contact_line?: string | null;
  sidebar_contact_text?: string | null;
  sidebar_show_portfolios?: boolean;
  sidebar_portfolios_limit?: number;
